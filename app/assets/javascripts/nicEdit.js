...
var nicEditorConfig = bkClass.extend({
	...
	iconsPath : '/assets/nic.png',
	buttonList : ['bold','italic','link'],
...
var nicEditors = {
	...
	DescriptionTextArea : function(nicOptions) {
		var textarea = document.getElementById("product_description");
			nicEditors.editors.push(new nicEditor(nicOptions).panelInstance(textarea));
		return nicEditors.editors;
	},
